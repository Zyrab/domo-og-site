...
export default function createTemplateEditor(template) {
  ...
  function notifyChange() {
    if (editorRef) {
      editorRef.dispatchEvent(new CustomEvent("template-update", { bubbles: true, detail: localTemplate }));
    }
  }
            ...
            .child([
              ...
              ...(el.type === "text"
                ? [
                  ...
                  createInput({ label: "Background Col", type: "text", value: el.backgroundColor || "transparent", name: `el-${i}-backgroundColor` }),
      ...
      Domo("div")
        ...
        .child([
          ...
          createInput({
            ...
            value: localTemplate.background?.type === "image" ? (localTemplate.background?.src || "") : (localTemplate.background?.value || "#ffffff"),
